...
election_data_csv_path = os.path.join("/Users/shade/Desktop/GitHub/python-challenge/PyPoll/Resources" ,"election_data1.csv")
# Open and read csv
with open(election_data_csv_path, newline="") as csvfile:
    ...
    for item in votes_per_candidate:
        ...
        #fourth = format((item[1][3])*100/(sum(count_candidate.values())),'.3f')
...
election_file = os.path.join("/Users/shade/Desktop/GitHub/python-challenge/PyPoll/Resources", "election_data.txt")
with open("/Users/shade/Desktop/GitHub/python-challenge/PyPoll/Analysis/election_file", "w") as outfile:
